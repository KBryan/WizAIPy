...
**Date**: 2026-09-14
**Level**: 2 — Better (CI, pre-commit and PR template added 2026-09-15; issue templates and a shared tool config still missing for Level 3)
...
7. Add issue templates (bug / feature) under `.github/ISSUE_TEMPLATE/`.
